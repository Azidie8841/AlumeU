    ...
    <div class="content">
      <form action="#">
        ...
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter Graduated Year" required>
          </div>
        </div>
        <div class="education-details">
        <div class="input-box">
            <span class="details">Other Technical Qualification (Optional)</span>
            <input type="text" placeholder="Enter other Technical Qualification" required>
          </div>
        </div>
        <br>
        <div class="gender-details">
        ...
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter Your Current Company" required>
        </div>
        <div class="input-box">
