    ...
    <div class="content">
      <form action="" method="post">
        <div class="user-details">
          <div class="input-box">
           <span class="details"> <b>Job Title</b></span>
            <input type="Text" placeholder="Enter Job Title" name="Title" value= "<?php echo $JobTitle ?>"required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter name Company" name="Name" value= "<?php echo $NameOfCompany ?>"required>
          </div>
          <div class="input-box">
            <span class="details">Salary Offer (RM)</span>
            <input type="text" placeholder="Enter Salary" name="Salary" value= "<?php echo  $Salary ?>"required>
          </div>
        </div>
        <br>
        ...
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter Qualification" name="Qualify"value= "<?php echo $Qualify ?>">
          </div>
        </div>
        <br>
        <div class="education-details">
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter skill" name="skill"value= "<?php echo  $skill?>">
          </div>
        </div>
        <br>
        <div class="education-details">
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter Job Description" name="Description"value= "<?php echo  $Description ?>">
          </div>
        </div>
        <br>
        <div class="button">
