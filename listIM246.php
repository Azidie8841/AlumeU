                                        ...
                                        <?php
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                              ...
                                              echo  "<tr>
                                                    ...
                                                    <a href='updateIM246.php?ContentID=$ContentID'class='btn btn-primary' name:='btn1'><i class='fas fa-pen'></i>Edit</a>
                                                    <a href='deleteIM246.php?ContentID=$ContentID'class='btn btn-danger'name:='btn2'> <i class='fas fa-trash-alt'></i>Delete </a>
                                                   </div>
                                                   </td>
                                                    </tr>";
                                             }
