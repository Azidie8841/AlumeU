...
$cek_kode=mysqli_query($conn,"select * from IM247 where IDNumber='$IDNumber'");

 $cek=mysqli_num_rows($cek_kode);
if($cek>0){
  echo "<script>alert('Error? You has already registered!');</script>";
}
else{
   $sql="INSERT INTO IM247 (IDNumber,fullname,Email,linkedin,Branch,Year,highestedulevel,othertechskill,Currectcomp,Currectpos,SalaryRange,numb) VALUES ( '$IDNumber','$Fullname','$Email','$linkedin','$Branch','$Year','$education','$othertechskill', '$Currectcomp','$Currectpos', '$SalaryRange', '$numb')";
   if ($conn->query($sql) === TRUE) {
    echo "<script>alert('Submit Succesfully! Congrats you has become one of our Alumni Community!');</script>";
  } else {
      ...
      <form action="" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="Name" placeholder="Enter your Fullname" name="Fullname" required>
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your number" name="numb"required>
          </div>
          <div class="input-box">
            <span class="details">Linked account link</span>
            <input type="text" placeholder="Enter your linkedin link" name="linkedin" required>
          </div>
        </div>
        <br>
        ...
        <div class="gender-details">
          <input type="radio" name="branch" id="dot-1" value="Puncak Perdana Branch">
          <input type="radio" name="branch" id="dot-2" value="Machang Branch">
          <input type="radio" name="branch" id="dot-3" value="Rembau Branch">
          <input type="radio" name="branch" id="dot-4" value="Segamat Branch">
          <input type="radio" name="branch" id="dot-5" value="Merbuk Branch">
          <input type="radio" name="branch" id="dot-6" value="Kota Samarahan Branch">
        ...
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter Graduated Year" name="Year"required>
          </div>
        </div>
        <div class="education-details">
        <div class="input-box">
            <span class="details">Other Technical Qualification (Optional)</span>
            <input type="text" placeholder="Enter other Technical Qualification" name="othertechskill"required>
          </div>
          <p>*Please Put null if empty<p>
        </div>
        <br>
        <div class="gender-details">
          <input type="radio" name="education" id="dot-7" value="Bachelor Degree">
          <input type="radio" name="education" id="dot-8" value="Master">
          <input type="radio" name="education" id="dot-9" value="Doctorate">
        ...
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter Your Current Company" name="Currectcomp"required>
        </div>
        <div class="input-box">
            <span class="details">Current Position</span>
            <input type="text" placeholder="Enter Your Current Position" name="Currectpos" required>
          </div>
        </div>
        <div class="gender-details">
          <input type="radio" name="Salary" id="dot-10" value="RM2000-RM2499" >
          <input type="radio" name="Salary" id="dot-11" value="RM2500-RM2999">
          <input type="radio" name="Salary" id="dot-12" value="RM3000-RM3999">
          <input type="radio" name="Salary" id="dot-13" value="RM3999 and upper">
