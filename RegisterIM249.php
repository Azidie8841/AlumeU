...
$cek_kode=mysqli_query($conn,"select * from IM249 where IDNumber='$IDNumber'");
...
if($cek>0){
  echo "<script>alert('Error? You has already registered!');</script>";
   ...
   $sql="INSERT INTO IM249 (IDNumber,fullname,Email,linkedin,Branch,Year,highestedulevel,othertechskill,Currectcomp,Currectpos,SalaryRange,numb) VALUES ( '$IDNumber','$Fullname','$Email','$linkedin','$Branch','$Year','$education','$othertechskill', '$Currectcomp','$Currectpos', '$SalaryRange', '$numb')";
